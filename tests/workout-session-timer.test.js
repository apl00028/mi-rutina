...
test("el cronómetro se inicia automáticamente al entrar en Entrenamiento activo",()=>{
  const api=loadApi();
  ...
  assert.match(navigation,/screen==="workout"[\s\S]*ensureWorkoutSessionTimerStarted/);
});
