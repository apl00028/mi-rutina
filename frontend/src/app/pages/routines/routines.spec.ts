...
describe('Routines training analytics', () => {
  ...
  it('does not keep a second training export in analysis', async () => {
    const fixture = await createLoadedComponent();
    fixture.componentInstance.trainingView.set('analysis'); fixture.detectChanges();
    expect(pageText(fixture)).not.toContain('Exportar registros');
    expect(fixture.nativeElement.querySelector('.export-panel')).toBeNull();
  });
